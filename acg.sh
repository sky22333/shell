...
# 安装 PHP 8.1 及其他必要的软件包
sudo apt-get install -y -q mariadb-server \
    php8.1 php8.1-mysql php8.1-fpm php8.1-curl php8.1-json \
    php8.1-cgi php8.1-mbstring php8.1-xml php8.1-gd \
    php8.1-xmlrpc php8.1-soap php8.1-intl php8.1-opcache php8.1-zip \
    wget unzip apache2 socat curl
